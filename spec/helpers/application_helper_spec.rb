...
describe ApplicationHelper do
  ...
  context "show_user_create_course_button" do
    ...
    it "works for no enrollments setting" do
      ...
      user_factory
      expect(show_user_create_course_button(@user.principal)).to be_truthy
      course_with_teacher
      expect(show_user_create_course_button(@teacher.principal)).to be_falsey
      account_admin_user
      expect(show_user_create_course_button(@admin.principal)).to be_truthy
    end
  end
