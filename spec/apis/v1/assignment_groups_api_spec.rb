    ...
    expected = [
      {
        ...
        "sis_source_id" => nil,
        "assignments" => [
          controller.assignment_json(@a3, @user.principal, session).as_json,
          controller.assignment_json(@a4, @user.principal, session, include_discussion_topic: false).as_json
        ]
      },
      {
        "group_weight" => 40.0,
        ...
        "sis_source_id" => nil,
        "assignments" => [
          controller.assignment_json(@a1, @user.principal, session).as_json,
          controller.assignment_json(@a2, @user.principal, session).as_json
        ]
      }
    ]
    ...
    expected = [
      {
        ...
        "sis_source_id" => nil,
        "assignments" => [
          controller.assignment_json(a1, @user.principal, session, include_all_dates: true, include_can_edit: true).as_json,
          controller.assignment_json(a2, @user.principal, session, include_all_dates: true, include_can_edit: true).as_json
        ]
      }
    ]
