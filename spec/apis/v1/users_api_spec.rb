...
class TestUserApi
  ...
  attr_accessor :services_enabled, :context, :params, :request
  attr_reader :current_principal, :current_user
    ...
    describe "Temporary Enrollments" do
      ...
      context "when feature flag is enabled" do
        ...
        it "includes temporary_enrollment_source_user_id attribute" do
          enrollment_json = @test_api.enrollment_json(temp_enrollment.reload, current_principal, nil)
