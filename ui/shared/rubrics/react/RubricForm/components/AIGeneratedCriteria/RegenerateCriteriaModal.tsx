...
type RegenerateCriteriaModalProps = {
  open: boolean
  isCriterion?: boolean
        ...
        <TextArea
          ...
          messages={
            additionalPrompt.length > 1000
              ? [
                  {
                    text: I18n.t('Additional prompt information must be less than 1000 characters'),
                    type: 'error',
                  },
                ]
              : undefined
...
export default RegenerateCriteriaModal
