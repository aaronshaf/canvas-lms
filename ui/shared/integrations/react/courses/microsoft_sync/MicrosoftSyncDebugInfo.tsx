...
const usersList = (userIds?: (string | number)[]) => {
  if (userIds && userIds.length > 0) {
    return (
      <List size="small">
        {userIds.map((listItem: string | number) => (
...
const debugInfoItem = (item: DebugInfoEntry, index: number) => {
...
const MicrosoftSyncDebugInfo = ({debugInfo}: {debugInfo: DebugInfoEntry[]}) => {
