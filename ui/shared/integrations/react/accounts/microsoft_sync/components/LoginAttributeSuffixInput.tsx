 ...
 * @returns
 */
type Message = {text: string; type: 'error' | 'hint' | 'success' | 'screenreader-only'}
type LoginAttributeSuffixInputProps = {
  suffixInputHandler?: (event: React.ChangeEvent<HTMLInputElement>, value: string) => void
  loginAttributeSuffix?: string
  messages?: Message[]
}

const LoginAttributeSuffixInput = ({
  suffixInputHandler,
  loginAttributeSuffix,
  messages,
}: LoginAttributeSuffixInputProps) => {
  return (
    <>
      <TextInput
        renderLabel={
