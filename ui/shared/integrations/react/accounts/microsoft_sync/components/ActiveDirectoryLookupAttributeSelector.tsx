 ...
 * @returns
 */
type ActiveDirectoryLookupAttributeSelectorProps = {
  fieldChangedHandler?: (_e: unknown, data: {value?: string | number}) => void
  selectedLookupField?: string
}

const ActiveDirectoryLookupAttributeSelector = ({
  fieldChangedHandler,
  selectedLookupField,
}: ActiveDirectoryLookupAttributeSelectorProps) => {
  return (
    <>
      <SimpleSelect
        renderLabel={
