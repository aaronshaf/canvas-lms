...
type LoginAttributeSelectorProps = {
  attributeChangedHandler?: (_e: unknown, data: {value?: string | number}) => void
  selectedLoginAttribute?: string
}

export default function LoginAttributeSelector(props: LoginAttributeSelectorProps) {
  return (
    <>
      <SimpleSelect
        renderLabel={
