            ...
            <Table.Row>
              ...
              <Table.Cell>
                <TenantInput
                  ...
                  messages={
                    state.tenantErrorMessages as unknown as {
                      text: string
                      type: 'error' | 'success' | 'hint' | 'screenreader-only'
                    }[]
                  }
            ...
            <Table.Row>
              ...
              <Table.Cell>
                <LoginAttributeSuffixInput
                  ...
                  suffixInputHandler={(_event, value) => {
                    dispatch({
                      type: reducerActions.updateSuffix,
                      payload: {microsoft_sync_login_attribute_suffix: value},
                    })
                  }}
                  messages={
                    state.suffixErrorMessages as unknown as {
                      text: string
                      type: 'error' | 'success' | 'hint' | 'screenreader-only'
                    }[]
                  }
