...
export default class StudentDetailsView extends React.Component {
  ...
  renderHeader() {
    // @ts-expect-error -- legacy untyped React component
    const {student, unselectStudent} = this.props
  ...
  renderStudentProfile() {
    // @ts-expect-error -- legacy untyped React component
    const {student, triggerAssignment, selectPrevStudent, selectNextStudent} = this.props
  ...
  renderFollowOnAssignments() {
    // @ts-expect-error -- legacy untyped React component
    const {followOnAssignments = []} = this.props

    // @ts-expect-error -- legacy untyped React component
    const items = followOnAssignments.map((item, i) => (
  ...
  renderContent() {
    // @ts-expect-error -- legacy untyped React component
    const {isLoading, student} = this.props
