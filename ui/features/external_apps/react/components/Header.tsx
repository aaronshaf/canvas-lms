...
const Header = React.forwardRef(({children}: HeaderProps, ref: React.ForwardedRef<unknown>) => (
  <View as="header" margin="small none">
    ...
    <p>
      <Link ref={ref as unknown as React.LegacyRef<Link>} href="https://www.eduappcenter.com/">
