...
type DuplicateConfirmationFormProps = {
  onCancel: () => void
  onSuccess: () => void
  onError: (xhr: {responseText: string}) => unknown
  forceSaveTool?: false | (() => void)
  toolData: Record<string, unknown> & {verifyUniqueness?: unknown}
