...
export default class Configurations extends React.Component<ConfigurationsProps> {
  static propTypes = {
    env: PropTypes.object.isRequired,
  }

  headerRef: {focus: () => void} | null = null
  ...
  setHeaderRef = (node: unknown) => {
    this.headerRef = node as {focus: () => void} | null
  }
