...
const foregroundColor = (selected: boolean) => (selected ? 'primary-inverse' : 'brand')
...
const ButtonContainer = ({children, selected}: ButtonContainerProps) => (
  <View
    as="div"
...
export default function SubmissionTypeButton({displayName, icon, selected, onSelected}: SubmissionTypeButtonProps) {
...
const MoreOptionsButton = ({selected}: MoreOptionsButtonProps) => (
  <ButtonContainer selected={selected}>
