...
interface ExternalToolOptionsProps {
  activeSubmissionType?: string
  externalTools: any[]
  updateActiveSubmissionType?: (type: string, tool: any) => void
  selectedExternalTool?: any
}
...
export default function ExternalToolOptions({
  ...
  const otherTools = externalTools.filter((tool: any) => !isFavorite(tool))
