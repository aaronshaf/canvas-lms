...
export function renderPipe(item: any) {
  return item && <View margin="0 xx-small 0 xx-small">|</View>
}

function renderAvailability(assignment: any) {
  return (
    <>
...
export default function AssignmentDetails({assignment, submission}: AssignmentDetailsProps) {
  return (
    <>
