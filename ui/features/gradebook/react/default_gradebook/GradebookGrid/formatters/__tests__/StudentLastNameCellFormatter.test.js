...
describe('GradebookGrid StudentLastNameCellFormatter', () => {
  ...
  describe('#render() with an active student', () => {
    ...
    test('renders the student last name', () => {
      expect(studentGradesLink().innerHTML).toBe(student.last_name)
    })

    test('escapes HTML in the student last name', () => {
      student.last_name = '<span>Jones</span>'
      expect(studentGradesLink().innerHTML).toBe('&lt;span&gt;Jones&lt;/span&gt;')
    })
    ...
    test('handles blank student last name', () => {
      student.last_name = ''
      expect(studentGradesLink().innerHTML).toBe('&lt;No last name&gt;')
    })
  })
