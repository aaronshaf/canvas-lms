...
type DeveloperKeyScopeProps = {
  onChange: (event: {currentTarget: {checked: boolean; value: string}}) => void
  checked: boolean
  scope: Scope
}

const ScopesMethodUntyped = ScopesMethod as unknown as React.ComponentType<Record<string, unknown>>

const DeveloperKeyScope = (props: DeveloperKeyScopeProps) => {
  return (
    <View as="div" data-automation="developer-key-scope">
      <Flex alignItems="start" padding="small medium small none">
        ...
        <Flex.Item>
          <ScopesMethodUntyped method={props.scope.verb} />
        </Flex.Item>
      </Flex>
    </View>
  )
