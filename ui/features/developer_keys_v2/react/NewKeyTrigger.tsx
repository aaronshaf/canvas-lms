...
type DeveloperKeyModalTriggerProps = {
  store: {dispatch: (action: unknown) => unknown}
  actions: {
    developerKeysModalOpen: (mode: 'api' | 'lti') => unknown
    ltiKeysSetLtiKey: (isLti: boolean) => unknown
  }
  setAddKeyButtonRef: (node: HTMLElement | null) => void
}
    ...
    return (
      <div>
        <Button
          ...
          color="primary"
          elementRef={this.props.setAddKeyButtonRef as unknown as (node: unknown) => void}
