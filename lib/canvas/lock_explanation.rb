    ...
    def lock_explanation(hash, type, context = nil, options = {})
      ...
      if hash[:lock_at]
        ...
        if context && (obj.workflow_state != "unpublished")
          ...
          link_wrapper = tag.a(
            "\\1".html_safe,
            href: course_context_modules_url(context || obj.context, anchor: "module_#{obj.id}", **url_options),
            class: "module_prerequisites_fallback",
            style: ("display: none;" if include_js)
          )
