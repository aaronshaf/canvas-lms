...
module Canvas::OAuth
  module ClientCredentials
    module LtiAdvantage
      # Site-admin-only provider that issues an LTI access token for any tool
      # without going through the normal assertion flow. Used by support staff
      # to impersonate any LTI tool.
      # warning: make sure whatever calls this is behind a require_site_admin
      # check, or anyone can get an access token for any tool
      class SupportTokenProvider < Canvas::OAuth::ClientCredentials::Provider
