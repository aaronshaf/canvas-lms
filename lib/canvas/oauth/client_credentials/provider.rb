...
module Canvas::OAuth
  ...
  module ClientCredentials
    ...
    class Provider < Canvas::OAuth::Provider
      ...
      def token_url(host, protocol)
        Rails.application.routes.url_helpers.oauth2_token_url(host:, protocol:)
      end
