...
module Api::V1::Json
  ...
  #
  # if no principal/session is given, permissions will not be considered during
  ...
  def api_json(obj, current_principal, session, opts = {}, permissions_to_return = [])
    permissions = { user: current_principal, session:, include_permissions: false }
